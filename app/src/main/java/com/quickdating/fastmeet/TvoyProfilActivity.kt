...
import com.quickdating.fastmeet.fragments.OstInfaFragment
import com.quickdating.fastmeet.fragments.PravilaFragment
import de.hdodenhof.circleimageview.CircleImageView
import io.reactivex.Observable
import io.reactivex.android.schedulers.AndroidSchedulers
import io.reactivex.schedulers.Schedulers
import kotlinx.android.synthetic.main.activity_tvoy_profil.*
import kotlinx.android.synthetic.main.app_bar_user_profile.*

class TvoyProfilActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tvoy_profil)
        ...
        the_intent1 = Intent(this, RedactirovanieProfilyaActivity::class.java)
        the_fragmentMain = OstInfaFragment()
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_help -> {
                the_fragmentMain = PravilaFragment()
                setFragment(the_fragmentMain)
            }
