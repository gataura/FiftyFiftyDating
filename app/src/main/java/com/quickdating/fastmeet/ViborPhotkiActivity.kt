...
class ViborPhotkiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_vibor_photki)

        the_imgHolder = findViewById(R.id.photka_image)
        the_takePicButt = findViewById(R.id.sdelat_photo_knopka)
        the_selectImgButton = findViewById(R.id.vibrat_photo_knopka)
        the_nextButton = findViewById(R.id.zavershit_knopka)
